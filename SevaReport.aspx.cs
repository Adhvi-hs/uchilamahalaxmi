...
namespace Temple
{
    public partial class SevaReport : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (fd < td)
            {
                SqlCommand cmd = new SqlCommand("select * from Bookseva where  Date between'" + TextBox1.Text + "'and'" + TextBox2.Text + "'", con);
                con.Open();
