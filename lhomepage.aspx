<%@ Page Title="" Language="C#" MasterPageFile="~/lhome.Master" AutoEventWireup="true" CodeBehind="lhomepage.aspx.cs" Inherits="Temple.lhomepage" %>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                    <div class="icon-box">
                        ...
                        <h4 class="title"><a href="seva.aspx"  >Seva Booking</a></h4>
                        <p class="description">Book your seva and pay online to get the token.</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="200">
                    <div class="icon-box">
                        ...
                        <h4 class="title"><a href="darshana1.aspx"  >Darshana Booking</a></h4>
                        <p class="description">Book special darshana to avoid standing in line for hours and get your token.</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="300">
                    <div class="icon-box">
                        ...
                        <h4 class="title"><a href="donation.aspx"  >Donation</a></h4>
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="300">
                    <div class="member">
                        ...
                        <%--<img src="assets/img/portfolio/kumkumarchane.jpg" class="img-fluid" alt="">--%>
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row">
                ...
                <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <img src="assets/img/portfolio/t1.jpeg" />
                </div>
